...
OPTS=""
OPTS+="--id MUSIC "
OPTS+="--list_train /home/sunshiyu/Projects/iQuery-music/data/MUSIC/trainmusic.csv "
OPTS+="--list_val /home/sunshiyu/Projects/iQuery-music/data/MUSIC/testsepmusic.csv "
