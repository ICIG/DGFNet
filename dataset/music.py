...
class MUSICMixDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.split == 'train':
            ...
            csv_lis_path = "/home/sunshiyu/Projects/iQuery-music/data/MUSIC/testmusic.csv"
            csv_lis = []
        ...
        for n, infoN in enumerate(infos):
            ...
            for i in range(self.num_frames):
                ...
                path_frames[n].append(
                    os.path.join("/home/sunshiyu/Projects/iQuery-music/data/MUSIC/frames",
                        path_frameN[1:],
                        '{:06d}.jpg'.format(center_frameN + idx_offset)))
                path_frames_ids[n].append(center_frameN + idx_offset)
            path_frames_det[n] = os.path.join("/home/sunshiyu/Projects/iQuery-music/data/MUSIC/detection_results",
                        path_frameN[1:]+'.npy')

            #include motions
            path_motions[n] = os.path.join("/home/sunshiyu/Projects/iQuery-music/data/MUSIC/motion_features",
                        path_frameN[1:]+'.npy')

            path_audios[n] = os.path.join("/home/sunshiyu/Projects/iQuery-music/data/MUSIC/audio", path_audioN[1:])
